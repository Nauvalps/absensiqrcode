...
$(document).ready(function () {
    table = $("#presensi").addClass('nowrap').DataTable({
        ...
        "createdRow": function (row, data, index) {
            if (data.id_status == 1) {
                $('td', row).eq(5).html('<span class="label label-success">' + data.nama_status + '</span>');
            }
            else if (data.id_status == 2) {
                $('td', row).eq(5).html('<span class="label label-danger">' + data.nama_status + '</span>');
            }
            else {
                $('td', row).eq(5).html('<span class="label label-default">' + data.nama_status + '</span>');
            }
            if (data.id_khd == 1) {
