<div class="box box-widget">
    ...
    $params['level'] = 'H';
    $params['size'] = 4;
    $params['savename'] = FCPATH . "uploads/qr_image/" . $is_active . 'code.png';
    if($is_active == $params['data']) {
        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header bg-blue">
                <div class="widget-user-image">
                    <img class="img-responsive" src="<?php echo base_url('uploads/qr_image/') . $is_active . 'code.png'; ?>" />
                </div>
                <!-- /.widget-user-image -->
