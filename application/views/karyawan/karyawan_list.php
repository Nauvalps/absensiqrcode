                ...
                <div class="box-body">
                    ...
                    <table id="mytable" class="table table-bordered table-hover display" style="width:100%;">
                        <thead>
                            <tr>
                                <th class="all">No.</th>
                                <th class="desktop">ID Karyawan</th>
                                <th class="all">No KTP</th>
                                <th class="all">Nama Karyawan</th>
                                <th class="desktop">Jabatan</th>                                                                
                                <th class="desktop">No Telepon</th>                                
...
<script src="<?php echo base_url() ?>assets/app/datatables/karyawan_list.js" charset="utf-8"></script>