            ...
            <div class='box box-success'>
                <div class='box-header'>
                    <div class="col-md-4 col-md-6 col-md-push-4">
                        ...
                        <h3 class='box-title'>
                            <p align="center"> DETAIL DAFTAR KARYAWAN <?php echo $gedung->nama_gedung ?></p>
                        ...
                        <tbody>
                            ...
                            foreach ($gedung_data as $gedung) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $gedung->id_karyawan ?></td>
                                    <td><?php echo $gedung->nama_karyawan ?></td>                                
                                    <td><?php echo $gedung->no_ktp ?></td>
                                    <td><?php echo $gedung->nama_jabatan ?></td>
                                    <td><img src="<?= base_url('uploads/user_pict/' . $gedung->user_pict); ?>" width="70"></td>                                
                                </tr> <?php } ?>
                        </tbody>
                        <tr>
