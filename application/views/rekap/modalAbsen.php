    ...
    <div class="box-body">
        <div class="modal-content">
            <span id="print-area">
                    ...
                    <table style='margin-left:70px;'>
                        <tr>
                            <td style='padding:10px'>
                                <img src="<?php echo base_url(); ?>assets/images/logo.png" width='150px'></img>
                            </td>
                            <td> <br>
                ...
                <b style="padding-left : 30px">A = ALFA</b>&nbsp;&nbsp;&nbsp;
                <b style="padding-left : 30px">W = WFH</b>&nbsp;&nbsp;&nbsp;
                <b style="padding-left : 30px">C = CUTI</b>&nbsp;&nbsp;&nbsp;
        </div>
        ...
        <div class="modal-content" style="width:300px">
            ...
            <div class="modal-body form" style="height:300px;">
                <form action="#" id="form" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">
                        <label class="control-label col-md-3">Dokumen Sakit/Izin/Cuti</label>
                        <div class="col-md-10">                        
                            <input type="file" class="form-control" id="file_keterangan" name="file_keterangan" value="">
                        </div>                          
                    </div>                     -->
                    <br>
                    <div class="form-group">
