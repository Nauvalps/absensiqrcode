                ...
                <span id="print-area">
                    <table style='margin-left:130px;'>
                        <tr>
                            <td style='padding:50px'>
                                <img src="<?php echo base_url(); ?>assets/images/logo.png" width='200px'></img>
                            </td>
                            <td> <br>
                    ...
                    <table style='text-align:left;font-weight:bold;margin-left:40px;'>
                        <tr>                                                        
                            ...
                            <td class='tr'>:&nbsp;</td>
                            <td class='tr'><?= $user->first_name ?> <?= $user->last_name; ?></td>
                        </tr>               
                    </table> <br><br><br>
                    <table style='text-align: center;margin-top:-20px;' border="2" cellspacing="0" width="100%">
                        <thead>
                            <tr style='background-color:#00ccff !important'>
                                ...
                                <th width='130px' colspan="5">Total Ketidakhadiran </th>
                            </tr>
                            <tr style='background-color:#00ccff !important'>
                                <th width='80px'>&nbsp; Sakit</th>
                                <th width='80px'>&nbsp; Ijin </th>
                                <th width='80px'>&nbsp; WFH </th>
                                <th width='80px'>&nbsp; Alfa </th>
                                <th width='80px'>&nbsp; Cuti </th>
                            </tr>
                        </thead>
                        <?php
                        $no = 0;
                        ...
                        foreach ($this->rekap->karyawan($segment) as $row) {
                            ...
                            $wfh = $this->rekap->totalHadir4($segment, $row->id_karyawan, $start, $end);
                            $alpha = $this->rekap->totalHadir5($segment, $row->id_karyawan, $start, $end);
                            $cuti = $this->rekap->totalHadir6($segment, $row->id_karyawan, $start, $end);
                            echo "<tr>
                            <td>" . $no . "</td>
