...
class Rekap_model extends CI_Model
{
    ...
    function karyawan_bak3($id, $start, $end)
    {
        $start = $_GET['start'];
        $end = $_GET['end'];
        // $id_shift = $_GET['id_shift'];
        $this->db->select("a.id_karyawan,a.nama_karyawan,a.jabatan,b.nama_jabatan,d.nama_gedung,e.id_khd,e.ket
        ,g.nama_status");
        $this->db->from("karyawan as a,jabatan as b, gedung as d,presensi as e,kehadiran as f, stts as g");
    ...
    function totalHadir5($id, $id_karyawan, $start, $end)
    {
        $start = $_GET['start'];
        $end = $_GET['end'];
        $this->db->select("a.gedung_id,b.id_karyawan,c.tgl");
    ...
    function totalHadir6($id, $id_karyawan, $start, $end)
    {
        $start = $_GET['start'];
        $end = $_GET['end'];
        $this->db->select("a.gedung_id,b.id_karyawan,c.tgl");
    ...
    function insert_khd()
    {
        // $file = $this->request->getFile('file_keterangan');
